	...
	<script>
		...
		function look() {
			...
			layui.use('table', function(){
				...
				table.render({
				    elem: '#demo' // 绑定控件
					,url: 'TicketServlet?op=serachYe&state=1&goodName='+goodName+'&user='+user // 数据接口
				    ,cols: [[ // 表头
				       {field: 'goodName', title: '商品', templet: '<div>{{d.goods.goodName}}</div>'}
