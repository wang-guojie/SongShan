...
<body id="about">
	<div class="main block">
		<div class="main_right">
			<h1>新增</h1>
			<form action="wenhuaservlet?op=add" method="post">
			<table  width="600px">
			<tr>
			<td>标题:</td>
			<td><input type="text" name="culturename" id="culturename" ></td>
			</tr>
			<tr>
			<td>内容:</td>
			<td><input type="text" name="cultureexplanation" id="cultureexplanation"></td>
			</tr>
				<tr>
			<td>文件上傳:</td>
			<td><input type="file" name="filedName" id="filedName"></td>
			</tr>
			<tr>
			<td colspan="2">
...
$(document).onclick(
				...
				function() {
					...
					var city = $("#cultureexplanation").val();
					...
					if (city == "-1") {
						$("#cultureexplanation").css("border", "1px solid red");
						layer.msg('内容不可以为空');
						return false;
					}
</script>
...
$("form").submit(
		function(){
		var titlename = $("#titlename").val();
		var cultureexplanation = $("#cultureexplanation").val();
