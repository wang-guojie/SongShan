		...
		<div class="layui-card layui-anim layui-anim-scaleSpring" id="home">
			...
			<div class="layui-card-body" style="text-align: center; width: 95%;">
				<div class="layui-card-body layui-form layui-form-pane"">
					<!-- 商品主图 -->
					<img src="../upload/2-1504099430804.jpg" id="imgSrc" style="max-height:200px;">
					<!-- 商品名称 -->
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							<input type="number" min="0" value="" id="money"
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							<input class="layui-input" value="" id="inventory"
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							<input type="file" class="layui-input" name="file" accept="image/*" id="fileField"
					...
					<div class="layui-form-item layui-form-text" style="margin:21px 0px">
						...
						<div class="layui-input-block">
							<textarea name="desc" value="" id="desc" placeholder="请输入商品描述" class="layui-textarea"></textarea>
						</div>
					</div>
					<!-- 上传数据 -->
...
<script>
	...
	$(document).on("click","#btnAdd",function(){
		...
		$.post(
			"GoodsServlet",
			"op=add&typeId="+typeId+"&name="+name+"&desc="+desc+"&inventory="+inventory+"&imgSrc="+imgSrc+"&money="+money,
			function(data){
				if (data == "1") {
					// 设置信号
					sessionStorage.setItem("goodsAdd", "1");
