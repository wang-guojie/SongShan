		...
		<div class="layui-card layui-anim layui-anim-scaleSpring" id="home">
			...
			<div class="layui-card-body" style="text-align: center; width: 95%;">
				<div class="layui-card-body layui-form layui-form-pane"">
					<!-- 套票主图 -->
					<img src="${goodsM.imgSrc}" id="imgSrc"
						style="max-height:200px;">
					<!-- 套票名称 -->
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						<label class="layui-form-label">套票名称：</label>
						<div class="layui-input-block">
							<input type="text" value="${goodsM.goodName}" id="name" backName = "${goodsM.goodName}" required=""
					...
					<div class="layui-card" style="margin-top:15px">
						<div class="layui-card-body">
							<c:forEach items="${arr}" var="a">
								<input type="checkbox" name="goodsId" value="${a.id}" title="${a.goodName}" money="${a.money}" <c:if test="${AorB.if_one(goodsM.list, a.id)}">checked</c:if>>
							</c:forEach>
						</div>
					</div>
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							<input type="number" min="0" value="${goodsM.money}" id="money" lay-verify="required"
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							<input class="layui-input" value="${goodsM.inventory}" id="inventory" type="number"
					...
					<div class="layui-form-item" style="margin:21px 0px 0px 0px">
						...
						<div class="layui-input-block">
							...
							<input type="text" value="${goodsM.imgSrc}" id="textfield" class="layui-input"
								disabled>
						</div>
					</div>
					<!-- 套票描述 -->
					<div class="layui-form-item layui-form-text"
						...
						<div class="layui-input-block">
							<textarea name="desc" value="" id="desc" placeholder="请输入套票描述"
								class="layui-textarea">${goodsM.goodDesc}</textarea>
						</div>
					</div>
					<!-- 上传数据 -->
					<input type="hidden" value="${goodsM.id}" id="id" />
...
<script>
	...
	$(document).on(
			...
			function() {
				...
				// post
				$.post("GoodsMServlet", "op=update&id=" + id + "&goodsId=" + goodsId + "&name=" + name + "&desc=" + desc
