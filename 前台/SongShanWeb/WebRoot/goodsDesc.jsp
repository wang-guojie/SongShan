	...
	<div class="main">
		...
		<div class="shop_goods block">
			<div class="shop_img ticket">
				<img src="${goods.imgSrc}" alt="少林寺"><span></span>
			</div>
			<div class="shop_summary">
				...
				<p>
					库存：<em class="max">${goods.inventory}</em>件
				</p>
				<p>
				...
				<div>
					<strong>订购数量：</strong>
					<span class="noselect" id="del">-</span>
					<input type="text" value="1" data-max="5" class="en" id="count" i="${goods.id}">
					<span class="noselect" id="add">+</span>
				</div>
				<p class="button">
