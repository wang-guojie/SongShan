...
.ds-comment-body {
	...
	<div class="header">
		<div class="block">
			...
			<ul class="menu">
				...
				<li><a href="#" class="hover">留言</a></li>
			</ul>
		
		
		</div>
	</div>
	<div class="par ani_cloud ani_cloud_red block">
	...
	<div class="main block">
		<div class="main_left">
			<ul>
				<li><a href="about.php" class="hover">匿名留言</a></li>
				<li><a href="messageservlet?op=toadd">给我留言</a></li>
				<li><a href="about.php?softid=219"> </a></li>
				<li><a href="about.php?softid=220"> </a></li>
				<li><a href="about_message.php"> </a></li>
				<li><a href="about_complaint.php"> </a></li>
				<li><a href="about_questionnaire.php"> </a></li>
				<li><a href="about.php?softid=221"> </a></li>
			</ul>
		</div>
		<div class="main_right">
			<c:if test="${empty p}">
				<c:redirect url="messageservlet?op=fenye&index=1"></c:redirect>
			</c:if>

			<c:set var="num" value="0"></c:set>
			<ul class="list_pic_vert list_pic_vert_white culture_list ani block">
				<c:forEach items="${p.list}" var="a" varStatus="index">
					...
					<c:choose>
						<c:when test="${num < 1}">
							<div class="ds-post-main">
								...
								<div class="ds-comment-body">标题：${a.titlename}
									内容：${a.context} 时间：${a.messagetime}</div>
			...
			<a href="messageservlet?op=fenye&index=1">首页</a>
			<a href="messageservlet?op=fenye&index=${p.pageIndex-1}">上一页</a>
			<a href="messageservlet?op=fenye&index=${p.pageIndex+1}">下一页</a>
			<a href="messageservlet?op=fenye&index=${p.pageCount}">尾页</a>
		</div>
