...
<body id="about">
	...
	<div class="main block">
		<div class="main_left">
			<ul>
				<li><a href="about.php" class="hover">新增留言</a></li>
				<li><a href="about.php?softid=218"> </a></li>
		...
		<div class="main_right">
			...
			<form form action="messageservlet?op=add" method="post">
						...
						<td>
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="titlename" id="titlename" placeholder="请输入标题">
								</div>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="layui-form-item layui-form-text">
								...
								<div class="layui-input-block">
									<textarea name="context" id="context" placeholder="请输入内容"></textarea>
								</div>
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="2"><input type="submit" id="btn"   value="提交"></td>
					</tr>
				</table>
			</form>
